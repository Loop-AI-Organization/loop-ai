...
export const AILoader: React.FC<AILoaderProps> = ({
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-b from-[#1a3379] via-[#0f172a] to-black dark:from-gray-100 dark:via-gray-200 dark:to-gray-300 ${className}`}>
      <div
...
// Simple inline typing indicator for message bubbles
export const TypingIndicator: React.FC<{ size?: number }> = ({ size = 24 }) => {
  return (
